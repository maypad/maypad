...
public interface ProjectApi {
     ...
     */
    @GetMapping("/{id}")
    ProjectResponse getProject(@PathVariable int id);
     ...
     */
    @PutMapping("/{id}")
    ProjectResponse changeProject(@PathVariable int id, @Valid @RequestBody ChangeProjectRequest request);
    ...
    void refreshProject(@PathVariable int id);
