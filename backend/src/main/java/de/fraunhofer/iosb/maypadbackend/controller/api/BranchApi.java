...
public interface BranchApi {
     ...
     */
    @GetMapping
    List<BranchResponse> getBranches(@PathVariable int id);
     ...
     */
    @GetMapping("/{ref}")
    BranchResponse getBranch(@PathVariable int id, @PathVariable String ref);
    ...
    List<BuildResponse> getBuilds(@PathVariable int id, @PathVariable String ref);
    ...
    List<DeploymentResponse> getDeployments(@PathVariable int id, @PathVariable String ref);
    ...
    void triggerBuild(@PathVariable int id, @PathVariable String ref, @Valid @RequestBody BuildRequest request);
    ...
    void triggerDeployment(@PathVariable int id, @PathVariable String ref, @Valid @RequestBody DeploymentRequest request);
    ...
    void notifyRepoUpdate(@PathVariable int id, @PathVariable String ref, @RequestParam(value = "token") String token);
    ...
    void notifyBuildFailure(@PathVariable int id, @PathVariable String ref, @RequestParam(value = "token") String token);
