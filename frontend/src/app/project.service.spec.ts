  ...
  it('loads all branches for a specific project',
    fakeAsync(() => {
      service.loadBranches(2).subscribe((data) => {
        ...
        expect(data[0].buildFailureUrl).toEqual('https://maypad.de/projects/1/branches/master/builds/fail?token=jhdsbfajdbfhjbhvjdafb');
        ...
        expect(data[1].buildFailureUrl).toEqual('https://maypad.de/projects/1/branches/dev/builds/fail?token=sajkvdbfdjkvnfjksvnjkfdv');
